...
import { MdEventAvailable, MdInventory2, MdOutlineReceiptLong, MdPets, MdRefresh } from 'react-icons/md'
...
export function AdminDashboardPage() {
  ...
  return (
    <section className="admin-page">
      ...
      <div className="admin-hero"><div><span>Morning shift</span><h2>The cafe is running smoothly.</h2><p>Two reservations arrive in the next 30 minutes. Window 03 is still occupied.</p></div></div>
      ...
      <div className="admin-table-card">
        <div className="admin-table-card__heading"><div><h2>Recent orders</h2><p>Newest orders from the customer portal.</p></div></div>
