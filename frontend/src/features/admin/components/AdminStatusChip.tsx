function toneFor(value: string) {
  ...
  if (/(hủy|huỷ|cancel|expired|hết hạn|hết hàng|không đến)/.test(normalized)) return 'danger'
  if (/(hoàn thành|completed|paid|đã thanh toán|available|còn trống|hoạt động)/.test(normalized)) return 'success'
